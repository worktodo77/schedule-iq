...
- [x] Remove the pre-approval notice from this file and from the top of `LI-RC-spec.md` — both banners replaced with a READY TO PUBLISH banner (approved 2026-07-07).
